...
namespace Justpharm.Web.Services.Notification
{
    ...
    public class Notification
    {
        ...
        public Notification(string title, NotificationOptions options = null, IJSObjectReference jsObjectReference = null)
        {
            ...
            if (options == null || jsObjectReference == null)
                return;

            _jsObject = jsObjectReference;
